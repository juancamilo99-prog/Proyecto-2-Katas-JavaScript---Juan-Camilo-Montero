...
utiliza un bucle para sumar todas 
las duraciones solo de los álbumes de 
rock y luego imprime el total 
de estas duraciones por consola. */
...
let countDurationAlbum = 0;
// Añade tu código de bucle aquí

for (let index = 0; index < albums.length; index++) {
    if(albums[index].genre === "Rock"){
        countDurationAlbum += albums[index].duration;
    }
}

console.log("total duracion del album rock: "+countDurationAlbum);
