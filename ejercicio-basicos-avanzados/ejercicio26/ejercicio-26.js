/* Filtra una lista de canciones para crear 
una playlist que solo contenga canciones 
de rock que duren más de 5 minutos.
Utiliza un bucle para lograrlo e 
...
const elementPlayListFilter = songs.filter(element => element.genre === "Rock" && element.duration >=5);
rockPlaylist.push(elementPlayListFilter)

for (const elementRockPlay of rockPlaylist) {
    console.log(elementRockPlay);
}
