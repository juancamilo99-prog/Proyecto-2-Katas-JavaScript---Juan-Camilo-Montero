/* For...of avanzado: Usa un bucle for...of para recorrer todos 
los juguetes y añade los que tengan 
...
for (const element of toys) {
    if(element.sellCount >= 15) popularToys.push(element);
}

for (const element of popularToys) {
    console.log(element);
}