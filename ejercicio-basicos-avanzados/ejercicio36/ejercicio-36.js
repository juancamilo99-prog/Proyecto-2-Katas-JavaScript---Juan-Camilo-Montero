...
calcule su edad actual y retorne un nuevo array con los 
nombres de los actores y sus edades.
...
function calculateActorsAges(actors) {
  ...
  for (const elementActor of actors) {
    const edad = anioActual - elementActor.born;
    //console.log(edad);
    edadActual.push({
